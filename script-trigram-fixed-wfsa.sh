...
clang++ -std=c++11 -stdlib=libc++ PhonemeToLetter.cc CypherReader.cc -o 2.out
./2.out $cipher_file
clang++ -std=c++11 -stdlib=libc++ EnglishPhonemeTrigramModel.cc EMViterbiPackage/Notation.cc CypherReader.cc TagGrammarFinder.cc -o 1.out
./1.out $counts_file
